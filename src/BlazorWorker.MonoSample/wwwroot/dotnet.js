...
var STACK_MAX = 708832
    , DYNAMIC_BASE = 5951712
    , DYNAMICTOP_PTR = 708672;
...
var ___tm_timezone = (stringToUTF8("GMT", 708736, 4),
    708736);
...
var asmLibraryArg = {
    "d": ___assert_fail,
    "ca": ___clock_gettime,
    "Ga": ___cxa_allocate_exception,
    "za": ___cxa_begin_catch,
    "ya": ___cxa_end_catch,
    "Da": ___cxa_find_matching_catch_3,
    "Fa": ___cxa_throw,
    "o": ___lock,
    "xa": ___resumeException,
    "Q": ___syscall10,
    "g": ___syscall102,
    "qb": ___syscall12,
    "fa": ___syscall122,
    ...
    "Ea": invoke_vi,
    "ta": _kill,
    "Aa": _llvm_eh_typeid_for,
    "c": _localtime_r,
    "memory": wasmMemory,
    "Ha": _mono_set_timeout,
    "Ja": _mono_wasm_add_array_item,
    "Va": _mono_wasm_add_array_var,
    "Ia": _mono_wasm_add_bool_var,
    "Ka": _mono_wasm_add_frame,
    "m": _mono_wasm_add_number_var,
    "Wa": _mono_wasm_add_obj_var,
    "C": _mono_wasm_add_properties_var,
    "y": _mono_wasm_add_string_var,
    "Ta": _mono_wasm_bind_core_object,
    "Sa": _mono_wasm_bind_host_object,
    "La": _mono_wasm_fire_bp,
    "sa": _mono_wasm_get_by_index,
    "X": _mono_wasm_get_global_object,
    "wa": _mono_wasm_get_object_property,
    "vb": _mono_wasm_invoke_js_marshalled,
    "ub": _mono_wasm_invoke_js_unmarshalled,
    "Ba": _mono_wasm_invoke_js_with_args,
    "Ra": _mono_wasm_new,
    "ab": _mono_wasm_new_object,
    "tb": _mono_wasm_release_handle,
    "jb": _mono_wasm_release_object,
    "ea": _mono_wasm_set_by_index,
    "ka": _mono_wasm_set_object_property,
    "Na": _mono_wasm_typed_array_copy_from,
    "Pa": _mono_wasm_typed_array_copy_to,
    "Oa": _mono_wasm_typed_array_from,
    "Qa": _mono_wasm_typed_array_to_array,
    "v": _nanosleep,
    "e": _pthread_cleanup_pop,
    "f": _pthread_cleanup_push,
    "ra": _pthread_cond_destroy,
    "F": _pthread_cond_init,
    "la": _pthread_cond_timedwait,
    "q": _pthread_setcancelstate,
    "qa": _schedule_background_exec,
    "t": _sem_destroy,
    "u": _sem_init,
    "s": _sem_post,
    "H": _sem_trywait,
...
// SIG // bSDrn6L9x0/7X4M4rFF4Ej140VkLbPExzmfXnrgWiF6g
...
// SIG // AYI3AgEVMC8GCSqGSIb3DQEJBDEiBCBakjraNIDyk7fX
// SIG // mdDrHFuaD+LRKJPwlNqv0mOhOf8s4TBCBgorBgEEAYI3
// SIG // AgEMMTQwMqAUgBIATQBpAGMAcgBvAHMAbwBmAHShGoAY
// SIG // aHR0cDovL3d3dy5taWNyb3NvZnQuY29tMA0GCSqGSIb3
// SIG // DQEBAQUABIIBADCw29/G8mPLj3Q873yMtIEaM9gOYxm0
// SIG // mCiWsKYHU1jDRvAum558vdT5ckUCHCiRiHmk8/3ndhhE
// SIG // UJEsewraRRpNSXq/XaixUEeDIdAQZN5B0Z4rvpul8RVQ
// SIG // sI2exuZcmZkr2dXzsCkyiKG05pQloCqmGdbO7YU0YzhD
// SIG // 4kFgYHKMKSCO3QT1fay4NoJtw9Jqae0rTvnWUNkNDCnM
// SIG // BjkQBrc4+xxgMsbX5I7a4r+2R+Jqz2+vzntUK92kTn4X
// SIG // 9wlNdLWhdpEPxuutcpsBxj+x+a0plJdawvkCWuI04x+J
// SIG // f860VhuJbApl2YPSh0duyhDeFGDl8i/cJyVPomUD9UwW
// SIG // bAqhghLlMIIS4QYKKwYBBAGCNwMDATGCEtEwghLNBgkq
// SIG // hkiG9w0BBwKgghK+MIISugIBAzEPMA0GCWCGSAFlAwQC
// SIG // AQUAMIIBUQYLKoZIhvcNAQkQAQSgggFABIIBPDCCATgC
// SIG // AQEGCisGAQQBhFkKAwEwMTANBglghkgBZQMEAgEFAAQg
// SIG // KEMq+4vZP5SVY5u5ohqLXIVD8fPFo9KHtH59Dc2oNLkC
// SIG // Bl375sPEuhgTMjAyMDAxMTcxNjMzMjEuMjg0WjAEgAIB
...
// SIG // MDEwMA0GCSqGSIb3DQEBBQUAAgUA4cv3mzAiGA8yMDIw
// SIG // MDExNzE3MDYzNVoYDzIwMjAwMTE4MTcwNjM1WjB3MD0G
// SIG // CisGAQQBhFkKBAExLzAtMAoCBQDhy/ebAgEAMAoCAQAC
// SIG // AhMjAgH/MAcCAQACAhIMMAoCBQDhzUkbAgEAMDYGCisG
// SIG // AQQBhFkKBAIxKDAmMAwGCisGAQQBhFkKAwKgCjAIAgEA
// SIG // AgMHoSChCjAIAgEAAgMBhqAwDQYJKoZIhvcNAQEFBQAD
// SIG // gYEAUKM/nLLJstGC452NSkkjRIpFXdLpAzLfavO6LbnR
// SIG // s139yaCxwdiFvu+SVyRYvDTpkTdx+kJmJ1UHyaSg/6Bz
// SIG // VXnnaFs+h5OI2pf1zOLzfBFNshzw2a+wROCqAYdIBWJ8
// SIG // H6dAOv0NtKjMDbM/W2QebRv5Oq+AwBuEYHZq5EzLD1Ex
...
// SIG // SIb3DQEJEAEEMC8GCSqGSIb3DQEJBDEiBCC4Xd4iFgzc
// SIG // kUf/+96sZpzEDo5GGKfEKA03xjaYbZBbLjCB+gYLKoZI
...
// SIG // WXBF+oQAAAAAAQgwIgQgrZ6y4oql8bWzv89+2BOa7jEz
// SIG // y1hWIAkzV8HhGJfhdaIwDQYJKoZIhvcNAQELBQAEggEA
// SIG // QFgfQ5cAXstRlFpsLzWPgpgtdFWTOKs+XgUJA6K0ihrd
// SIG // QEncbuNZQjpg255iRVk/DQLrk2uR9psqEM0VZ8pNAk4j
// SIG // kwvxXdZVQxlSRxIKICpU+EsjP7e9sgbSBFBHbve27dSQ
// SIG // N/9sM4gUgpgPs3bEuOy9BpseL+Q22fjOgnTQekq4DMF1
// SIG // DV9e7ODs4v0IQ8nPY+WA0Rsd+9M3MeQUxHNHn7KXZlxJ
// SIG // pTbap/3jaJHE2QwKa8ca0afodGvOHHWs7xv8mCJ05eDP
// SIG // p2yOdqXtQNZc/KC1tgHCa9+vGXIGQx3w7WFFIDaPgp8z
// SIG // ar3GHSltay6OUCRbIsTpDonR5pXpPjRZcg==
